                            ...
                            <div class="card-body">
                                ...
                                onsubmit="validateLoginForm(event);">
                                    <div class="form-group">
                                        ...
                                        <i style="font-size:24px" id="toggleVisibility" class="fa fa-eye-slash" 
                                ...
                                <p><a href="./update_password.php" style="color: #224f9c;" class="text-decoration-none">Forgot your password?</a></p>
                                <p>Don't have an account? <a href="./register.php" style="color: #224f9c;" class="text-decoration-none">Register</a></p>
                                <p><a href="../index.php" class="btn" style="background: #224f9c; color: #eee">YouTube</a></p>
