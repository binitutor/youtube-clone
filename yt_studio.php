...
<head>
    ...
    <!-- <link rel="stylesheet" href="./assets/lib/coreui-5.2.0-dist/coreui.min.css"> -->
                    ...
                    <div class="studio-content">
                        <?php
                            ...
                            foreach ($videos as $video) {
                                ...
                                // Description: '. $video_description .'<br>
                                // URL: '. $video_url .'<br>
                                // Length: '. $video_length .'<br>
                                // Created at: '. $video_created_at .'<br>
                                // Created by: '. $video_created_by .'<br>
                                // Thumbnail: '. $video_thumbnail .'<br>
                                // Updated at: '. $video_updated_at .'<br>
                                // View count: '. $video_view_count .'<br>
                                // ';
                                        ...
                                        <div class="row" style="font-size:16px">
                                            ...
                                            <div class="col-7">
                                                ...
                                                <div class="video-actions">
                                                    ...
                                                    onclick="edit_video()"></i>
                                                    <i class="fa fa-bar-chart btn" title="Load video analytics"
                                                    onclick="load_video_analytics()"></i>
                            ...
                            <table class="table table-hover table-scrollable">
                                <thead>
                                    <tr>
                                        <th scope="col"></th>
                                        <th scope="col" colspan="8">Video</th>
                                        <th scope="col">Visibility</th>
                                        <th scope="col">Restriction</th>
                                        <th scope="col">Date</th>
                                        <th scope="col">Views</th>
                                        <th scope="col">Comments</th>
                                        <th scope="col">Likes vs Dislikes</th>
                                    </tr>
                                </thead>
                                <tbody class="table-group-divider">';
                        ...
                        ?>
                                ...
                                <!-- <tr>
                                    ...
                                    <td colspan="8" >
                                        <div class="row" style="font-size:16px">
                                            <div class="col-5">
                                                <img src="./assets/img/thumbnail1.png" class="rounded img-fluid">
                                            </div>
                                            <div class="col-7">
                                                <p>Video Title</p>
                                                <div class="video-actions">
                                ...
                                <!-- <div class="dropdown">
                                                        <i style="font-size:24px" class="fa fa-ellipsis-v btn" title="Options"
                                                        onclick="load_video_options()"></i>
                                                        <div class="dropdown-content">
                                                            <a href="#"><i class="fa fa-pencil mx-2" style="font-size:14px" ></i> Edit</a>
                                                            <a href="#"><i class="fa fa-trash" style="font-size:14px" ></i> Delete</a>
                                                        </div>
                                                    </div> -->
                            ...
                            style="display: none;">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- <div class="progress" role="progressbar" aria-label="Video upload" 
